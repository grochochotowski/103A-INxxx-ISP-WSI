...
<br>`assignment_01/backpack-problem/`    — Knapsack problem (Exhaustive & Heuristic)
<br>`assignment_01/steepest-descent/`    — Local search with GUI & CEC2017 support
<br><br>
...
```
cd src/assignment_01/steepest-descent/
